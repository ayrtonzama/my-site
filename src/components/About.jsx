    ...
    <div className="split__right">
      ...
      <div className="skills">
        <div className="skills__group">
          ...
          <p>Angular · RxJS · NgRX · HTML5 · CSS3/SCSS · React</p>
        </div>
        <div className="skills__group">
          <h4><Cross /> LANGUAGES</h4>
          <p>TypeScript (High-level) · Python (Mid-level) · C# (Mid-level) · Java (Mid-level)</p>
        </div>
        <div className="skills__group">
          <h4><Cross /> MOBILE</h4>
          <p>Swift · Kotlin · React Native · Flutter · Ionic · Java · C# </p>
        </div>
        <div className="skills__group">
          <h4><Cross /> TOOLING</h4>
          <p>Git · GitHub Actions · Jest · ESLint · Agile/Scrum · Cypress · Playwright</p>
        </div>
      </div>
    </div>
  </section>)
